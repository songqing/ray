...
#include "org_ray_spi_impl_PlasmaClientJNI.h"
#include "logging.h"
...
JNIEXPORT jlong JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_connect
...
JNIEXPORT void JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_disconnect
...
JNIEXPORT jobject JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_create
...
JNIEXPORT jbyteArray JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_hash
...
JNIEXPORT void JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_seal
  (JNIEnv *env, jclass cls, jlong conn, jbyteArray object_id)
{
    PlasmaClient *client = (PlasmaClient *) conn;
    ObjectID oid;
...
JNIEXPORT void JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_release
  (JNIEnv *env, jclass cls, jlong conn, jbyteArray object_id)
{
    PlasmaClient *client = (PlasmaClient *) conn;
    ObjectID oid;
...
JNIEXPORT jobjectArray JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_get
...
JNIEXPORT jboolean JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_contains
  (JNIEnv *env, jclass cls, jlong conn, jbyteArray object_id)
{
    PlasmaClient *client = (PlasmaClient *) conn;
    ObjectID oid;
...
JNIEXPORT void JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_fetch
...
JNIEXPORT jobjectArray JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_wait
...
JNIEXPORT jlong JNICALL Java_org_ray_spi_impl_PlasmaClientJNI_evict
